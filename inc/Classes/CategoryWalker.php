...
class CategoryWalker extends \Walker {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		if( !empty( $args['current_category'] ) && $args['current_category'] === $cat_id ) {
			$output .= ' current-cat';
		}

		if ( !empty( $args['current_category_ancestors'] ) && !empty( $args['current_category'] ) && in_array( $cat_id, $args['current_category_ancestors'], true ) ) {

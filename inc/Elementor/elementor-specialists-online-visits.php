...
class SpecialistsOnlineVisits extends \Elementor\Widget_Base {
	public function get_name() {
		return 'drplus_specialist_online_visits';
	}

	public function get_title() {
		return esc_html__( 'Specialists - Online visits (Doctor Plus)', 'drplus' );
	}
	...
	public function get_keywords() {
		return ['counselor', 'doctor', 'advise', 'online', 'visit', 'consultant', 'مشاور', 'دکتر', 'ویزیت', 'آنلاین', 'ثبت', 'پذیرش'];
	}

	protected function register_controls() {
		ElementorControls::specialists_query_control( $this, 'online_visits' );
		...
		ElementorControls::section_title_settings( $this, [
			'controls'	=> [
				'title'	=> [
					'default'	=> esc_html__( "Online medical visit", 'drplus' )
				],
				'icon'	=> [
					'default'	=> [
				...
				'link'	=> [
					'default'	=> [
						'url'	=> home_url( "/specialists?specialist-type=online" ),
					]
				],
			],
		] );
		...
		// Card styles
		ElementorControls::specialists_card_style_control( $this, 'online_visit' );
		...
		// Card styles
		ElementorControls::specialists_card_style_control( $this, 'online_visit', true );
	...
	protected function render() {
		...
		$settings['only_online_visits'] = true;
		...
		<div <?php echo Utils::get_html_attributes( $attributes ) ?>>
			...
			<?php } ?>
			<?php UtilsSpecialists::list( $settings, 'online_visits' ) ?>
		</div>
		<?php
	}
}